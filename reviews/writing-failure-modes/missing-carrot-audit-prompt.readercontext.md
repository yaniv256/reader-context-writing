...
Reader model: The evaluator receives a complete clean instructional document and must judge whether its requested actions are motivated for a reader who lacks the authoring conversation.
Does not know: Which instruction triggered the audit or what explanation the reporter wanted.
Cares about: Purpose, payoff, avoided cost, and why the requested action belongs at this point in the workflow.
Does not care about: Adding motivational slogans or repeating reasons the reader already understands.
Reader voice: "Why should I do this, and what will it accomplish?"
Unresolved: Which instructions assume compliance instead of earning it.
Next passage: Define a blinded full-document audit with a frozen rubric and false-positive controls.
Do not assume: That imperative wording alone is a failure or that every mechanical substep needs its own essay.
-->
